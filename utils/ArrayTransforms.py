...
def ConvertCAMxTime(date,time,nvars):
	f=descendAttrDict(dict(dimensions=dict(TSTEP=date.shape[0],VAR=nvars)))
	f.dimensions['DATE-TIME']=2
	...
	a=PseudoNetCDFVariable(f,'TFLAG','i',('TSTEP','VAR','DATE-TIME'),a[:,[0],:].repeat(nvars,1))
